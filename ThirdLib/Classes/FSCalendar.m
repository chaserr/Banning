...
//    
//    UIView *weekdayView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 320, 30)];
//    weekdayView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"v1_week_top"]];
